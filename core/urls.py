...
urlpatterns = [
    ...
    path('course/<int:pk>/gradebook-old/', views.StudentSubmissionsView.as_view(),
         name='studentsubmission-list'),
    path('course/<int:pk>/gradebook/', views.GradebookDetailView.as_view(),
         name='gradebook-list'),
    ...
    path('gradebook/studentsubmission/create/<int:student>/<int:course>/', views.StudentSubmissionCreateView.as_view(),
